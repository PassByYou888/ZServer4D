...
type
  ...
  public
    ...
    function ReadArrayByte(idx: Integer): TDataFrameArrayByte; overload;
    function ReadMD5(idx: Integer): UnicodeMixedLib.TMD5; overload;
    ...
    function ReadArrayInt64(idx: Integer): TDataFrameArrayInt64; overload;
    ...
    function ReadUInt64(idx: Integer): UInt64; overload;
    ...
    {$IFNDEF FPC}
    procedure ReadJson(idx: Integer; output: TJsonObject); overload;
    {$ENDIF}
