...
procedure TZDB2_List_MS64.DoNoSpace(Siz_: Int64; var retry: Boolean);
begin
...
begin
  ...
  tk := GetTimeTick;
  with TZDB2_List_MS64.Create(TZDB2_MS64, nil, 5000, m64, 64 * 1048576, 200, Cipher_) do
    begin
  ...
  tk := GetTimeTick;
  L := TZDB2_List_MS64.Create(TZDB2_MS64, nil, 5000, m64, 64 * 1048576, 200, Cipher_);
