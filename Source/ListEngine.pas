...
{$ENDIF FPC}
  ...
  public
    ...
    procedure Add(const Name: SystemString; Data_: Pointer; const Overwrite_: Boolean); overload;
...
procedure THashList.Add(const Name: SystemString; Data_: Pointer; const Overwrite_: Boolean);
var
  newhash: THash;
  L: NativeInt;
  lst: TCoreClassList;
