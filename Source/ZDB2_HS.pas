...
procedure TZDB2_List_HashString.DoNoSpace(Siz_: Int64; var retry: Boolean);
begin
...
begin
  ...
  tk := GetTimeTick;
  with TZDB2_List_HashString.Create(TZDB2_HashString, nil, 5000, m64, 64 * 1048576, 200, Cipher_) do
    begin
  ...
  tk := GetTimeTick;
  L := TZDB2_List_HashString.Create(TZDB2_HashString, nil, 5000, m64, 64 * 1048576, 200, Cipher_);
