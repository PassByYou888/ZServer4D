...
begin
  ...
  {  Suppose another server responds to the data after 3.5 seconds. At this time, it processes the command asynchronously, and then continues to feed back to the client  }
