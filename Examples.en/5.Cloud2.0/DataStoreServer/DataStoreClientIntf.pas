...
const
  cUserLoginInfoDB = 'UserLoginInfo'; {  Login history information  }
  cUserMessageDB = 'UserMessageDB';   {  User messages and messages  }
  cLogDB = 'LogDB';                   {  Log database  }
  cFogComputeDB = 'FogHistoryDB';     {  Fog calculation history database  }
