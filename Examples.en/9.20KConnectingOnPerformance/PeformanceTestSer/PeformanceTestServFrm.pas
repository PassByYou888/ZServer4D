...
type
  {  For server pressure test, the following interfaces can be selected  }
  {  Only crosssocket and diocp can resist concurrency. Other interfaces such as Indy and ICs can only be used for small-scale services within 500 links  }
