...
type
  ...
  {  The server can write instances directly, but the client should better encapsulate them and form a habit, otherwise the maintenance will be troublesome after the project pile is large  }
