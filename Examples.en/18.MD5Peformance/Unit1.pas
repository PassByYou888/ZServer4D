...
{$IFDEF WIN64}
  lbl1.Caption := 'Win64 compilation';
{$ELSE}
  lbl1.Caption := 'Win32 compilation';
{$ENDIF}
...
begin
  ...
  begin
    ...
    edt1.Text := Format('File size: %SMB load time: %d milliseconds',
    ...
    edt2.Text := 'Indy MD5 time consuming:' + IntToStr(GetTickCount - t) + 'MS MD5:' + sMD5;
    IndyMD5.Free;
    edt2.Repaint;
    ...
    edt3.Text := 'Fly MD5 time consuming:' + IntToStr(GetTickCount - t) + 'MS MD5:' + sMD5;
    edt3.Repaint;
    ...
    edt4.Text := 'Fast MD5 time consuming:' + IntToStr(GetTickCount - t) + 'MS MD5:' + sMD5;
    edt4.Repaint;
    ...
    edt5.Text := 'Qdac MD5 time consuming:' + IntToStr(GetTickCount - t) + 'MS MD5:' + sMD5;
    edt5.Repaint;
    ...
    edt6.Text := 'System MD5 time consuming:' + IntToStr(GetTickCount - t) +
      'MS MD5:' + sMD5;
    edt6.Repaint;
    ...
    edt7.Text := 'Mormot MD5 time consuming:' + IntToStr(GetTickCount - t) +
      'MS MD5:' + sMD5;
    morMD5.Finalize;
    edt7.Repaint;
