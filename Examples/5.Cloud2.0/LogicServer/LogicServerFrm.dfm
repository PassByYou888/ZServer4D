  ...
  object PageControl: TPageControl
    ...
    object OptTabSheet: TTabSheet
      ...
      object RecvPortEdit: TLabeledEdit
        ...
        EditLabel.Width = 122
        EditLabel.Height = 13
        EditLabel.Caption = 'Hall Receive Service port '
        LabelPosition = lpLeft
        TabOrder = 1
      end
      object SendPortEdit: TLabeledEdit
        ...
        EditLabel.Width = 107
        EditLabel.Height = 13
        EditLabel.Caption = 'Hall Send service port '
        LabelPosition = lpLeft
        TabOrder = 2
      end
      object PayRecvPortEdit: TLabeledEdit
        Left = 341
        Top = 38
        Width = 53
        Height = 21
        EditLabel.Width = 123
        EditLabel.Height = 13
        EditLabel.Caption = 'Pay Service Receive port '
        LabelPosition = lpLeft
        TabOrder = 3
      end
      object PaySendPortEdit: TLabeledEdit
        Left = 341
        Top = 65
        Width = 53
        Height = 21
        EditLabel.Width = 109
        EditLabel.Height = 13
        EditLabel.Caption = 'Pay Service Send port '
        LabelPosition = lpLeft
        TabOrder = 4
      end
    end
